...
.top{display:flex;gap:10px;align-items:center;flex-wrap:wrap;margin-bottom:10px}.top select,.top button{background:#20242a;color:#eee;border:1px solid #454b54;border-radius:6px;padding:7px 10px}
