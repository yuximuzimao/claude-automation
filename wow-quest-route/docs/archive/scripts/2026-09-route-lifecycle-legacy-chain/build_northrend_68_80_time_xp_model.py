...
def main() -> None:
    raise SystemExit(
        "RETIRED: legacy combined Northrend Timing/XP writer has been replaced by Route Lifecycle "
        "Stage 7 Timing + Stage 8 XP. Keep this module only as historical calibration/migration evidence; "
        "it must not write a second Derived Timing/XP product."
    )
