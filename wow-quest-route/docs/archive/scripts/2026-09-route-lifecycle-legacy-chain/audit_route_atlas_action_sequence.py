...
raise SystemExit(
    "RETIRED EXECUTION PATH: this legacy action-sequence diagnostic reparses generated player text "
    "and maintains its own active-task set without real entry RouteState. Stage 3 Route Replay now "
    "owns accept/objective/turnin legality from structured Profile actions and UNKNOWN-aware actual "
    "entry state. Keep this file only as historical diagnostic evidence."
)
