...
raise SystemExit(
    "RETIRED: this one-off patch edits legacy workbench point indexes 169/170 and point[6] transport. "
    "Stage 5 canonical movement now owns visit/edge movement; old page indexes and legacy transport "
    "must not be written as route truth. Keep this file only as historical migration evidence."
)
