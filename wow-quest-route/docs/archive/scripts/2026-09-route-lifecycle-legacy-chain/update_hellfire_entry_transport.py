...
raise SystemExit(
    "RETIRED: this one-off patch directly edits the legacy Hellfire workbench first point/HUD text. "
    "Stage 5 canonical movement plus the later Display/Publisher stages now own the replacement path; "
    "Generated Product must not be patched as business truth. Keep this source only as migration evidence."
)
