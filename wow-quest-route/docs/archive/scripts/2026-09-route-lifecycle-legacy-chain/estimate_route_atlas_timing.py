...
def main() -> None:
    raise SystemExit(
        "RETIRED: legacy Route Atlas timing writer has been replaced by Route Lifecycle Stage 7 "
        "(lib.route_timing + scripts/rebuild_route_profile.py). Historical helper functions remain "
        "importable for migration/UI regression evidence only; this script must not write timing truth."
    )
