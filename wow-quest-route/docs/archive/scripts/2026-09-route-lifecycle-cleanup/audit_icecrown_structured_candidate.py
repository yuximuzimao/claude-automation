...
raise SystemExit(
    "RETIRED EXECUTION PATH: this Icecrown structured-candidate audit mixes legacy publication checks "
    "with task-state reconstruction from old generated actionHtml. Stage 3 Route Replay now owns task "
    "state/log legality from Route Profile actions; later Stage 11/14 work may mine this file as historical "
    "audit evidence, but it must not run as a parallel validator. Use scripts/rebuild_route_profile.py."
)
