...
def main() -> None:
    raise SystemExit(
        "RETIRED: legacy 35-55 combined cost/XP writer has been replaced by Route Lifecycle Stage 7 "
        "Timing + Stage 8 XP. Historical helpers remain source evidence only; this script must not "
        "write a second timing/XP model."
    )
