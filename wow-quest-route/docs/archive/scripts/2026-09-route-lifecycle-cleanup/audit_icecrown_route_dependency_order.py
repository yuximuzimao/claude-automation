...
raise SystemExit(
    "RETIRED EXECUTION PATH: this Icecrown dependency-order audit reparses legacy route prose and "
    "reimplements pre_any/pre_all/parent_active ordering. Stage 3 Route Replay now owns those "
    "Availability semantics from Task Cards + structured Profile actions. Missing-coverage ideas may "
    "be mined later by Stage 10/14, but this parallel validator must not execute."
)
