    ...
    steps = [
        ...
        },
        {
            ...
            "actions": [
                ...
                "缝合场东侧约37.1,71.2 → 主控调查召唤祭坛完成《它们从哪儿来的？》；回黑色观察站交《它们从哪儿来的？》 → 接《摧毁祭坛》《死亡的凝视》",
        ...
        },
        {
            ...
            "task_cards": {
                ...
                "13343": {"name": by_id[13343]["name"], "route_note": "克罗米顶层接/交；青铜巨龙圣地约72,39完成。", "fivebox": "待实测：先按《永恒之龙的秘密》的2+2+1三批方式执行。"},
        ...
        {
            "step": 30,
            "title": "奥尔杜萨：路障 + 晋升者奥鲁麦斯 → 回舰打开南下三任务",
            "actions": [
        ...
        },
        {
            ...
            "actions": [
                ...
                "哭泣采掘场约39,35 → 《不择手段》共享：直接用角色本体组队击杀20名永不休息的斥候；不必使用幻象观察者刺杀",
