...
MANUAL = {
    11984: {
        "facts": ["共享：先与Budd对话取得控制/技能，再对单独巨魔使用指定能力完成抓捕；一号完成可同步五号。"],
    },
    11990: {
        "facts": ["不共享：先购买水晶瓶；商人一次购买直接得到5个，只需买一次。沿湖区收集水草叶并取得3片朦胧叶，再回达库鲁。"],
    },
    11991: {
        "facts": ["不共享：冰冻魔精可交易；每号都要自己在南侧火盆使用达库鲁药剂召唤影像，召唤NPC不共享。当前号背包里若有超过任务所需的多余冰冻魔精会无法正常交任务，交前先移走多余魔精。"],
    },
    12007: {
        "facts": ["不共享：所需魔精由五号依次拾取，预言者之眼也需要五号依次交互取得，再分别到北侧火盆使用达库鲁药剂交接。"],
    },
    12259: {
        "facts": ["共享：骑任务龙完成沃德伦领主载具战，一号完成可同步五号。"],
    },
    12026: {
