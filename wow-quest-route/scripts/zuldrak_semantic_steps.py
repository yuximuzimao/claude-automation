...
DISPLAY_SPLITS: dict[int, list[tuple[int, int, str]]] = {
    ...
    10: [(3, 8, "希姆托加 → 犸托斯 / 佐尔玛兹"), (4, 9, "希姆托加 → 古达克 → 阿卡里")],
    ...
    specs: dict[int, dict[str, Any]] = {
        ...
        3: {
            ...
            "points": [
                ...
                {"title": "盖米尔载具", "action": "↳ 做《风暴之王的复仇》", "note": "《风暴之王的复仇》：共享：开始载具战斗前先把其余角色移动到Boss附近，避免距离过远丢失共享信用。"},
        ...
        4: {
            ...
            "points": [
                ...
                {"title": "沃尔塔鲁斯", "action": "达库鲁大王 → 接《无法容忍》\n↳ 做《无法容忍》《危险的材料》\n达库鲁大王 → 交《无法容忍》", "note": "《危险的材料》：不共享：", "fivebox": "确认《无法容忍》的仆从控制是否需五号分别完成。"},
                {"title": "痛苦之匣", "action": "使用斯特凡号角\n斯特凡·瓦杜 → 交《危险的材料》 → 接《爆破活动》"},
                {"title": "沃尔塔鲁斯 → 上层密室 → 痛苦之匣", "action": "达库鲁大王 → 接《火上浇油》\n↳ 做《火上浇油》\n达库鲁大王 → 交《火上浇油》 → 接《真相大白》\n使用传送器：进入上层密室\n↳ 做《真相大白》\n达库鲁大王 → 交《真相大白》\n↳ 做《爆破活动》", "note": "《真相大白》：不共享：五号依次进入并交互完成。", "fivebox": "确认《火上浇油》的控制憎恶与《爆破活动》的炸药束进度是否共享。"},
                {"title": "痛苦之匣", "action": "使用斯特凡号角\n斯特凡·瓦杜 → 交《爆破活动》 → 接《背叛》"},
        ...
        5: {
            ...
            "points": [
                ...
                {"title": "扎尔金之池", "action": "↳ 做《吸取灵魂》", "note": "《吸取灵魂》：不共享："},
        ...
        6: {
            ...
            "points": [
                ...
                {"title": "蛛魔弹坑", "action": "↳ 做《扔手雷》", "note": "《一个也不能少》：这里先不救人；先回鲁伯特上尉处交《扔手雷》并接出《茧中人》，再把两个救援任务合并完成。"},
                ...
                {"title": "达克索塔北侧", "action": "↳ 做《腐蚀者玛拉斯》《坠毁的喷射器》《纯粹的邪恶》", "note": "《坠毁的喷射器》：不共享：\n《纯粹的邪恶》：不共享："},
        ...
        10: {
            ...
            "summary": "库弗收神灵链、图基尼收拖带；埃霍奈/德苟达/图基尼/哈克娅分别接四条北部任务。完成猛犸和佐尔玛兹后回各NPC交付，再开古达克飞行点并释放阿卡里，之后直接返回希姆托加。",
            "points": [
        ...
        11: {
            ...
            "summary": "先取希姆鲁克守卫者与奎丝鲁恩典狱官两份精华，向哈克娅交《诸神的指引》接佐尔赫布；击杀阿卡里先知后直接返回希姆托加向哈克娅交接《未完的事情》。",
            "points": [
        ...
        12: {
            "title": "杜布拉金 → 古达克迅猛龙卵",
            "summary": "从希姆托加直接到杜布拉金；托玛尔、拜基妮交两条携带任务，哈瓦纳接迅猛龙卵；五号完成后回哈瓦纳交付。",
            "points": [
            ...
            "action_html": [point_anchor("杜布拉金"), npc_actions("托玛尔", turns=("未完的事情",)), npc_actions("记载者拜基妮", turns=("核实情况",)), npc_actions("哈瓦纳", accepts=("杜布拉金需要迅猛龙卵",)), do_at("古达克迅猛龙卵", "杜布拉金需要迅猛龙卵"), npc_actions("哈瓦纳", turns=("杜布拉金需要迅猛龙卵",))],
