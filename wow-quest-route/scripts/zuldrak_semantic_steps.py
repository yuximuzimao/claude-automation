...
DISPLAY_SPLITS: dict[int, list[tuple[int, int, str]]] = {
    ...
    7: [(2, 13, "痛苦斗兽场：伊戈达斯 → 海象人"), (3, 13, "痛苦斗兽场：科尔拉克 / 冠军 → 希姆托加"), (1, 6, "希姆托加：金亚莱交任务 / 神灵链")],
    8: [(5, 15, "哈克娅 → 伦诺克完整链"), (5, 14, "希姆托加 → 赫布达卡 → 哈克娅")],
...
def apply_zuldrak_semantic_overrides(points: list[list[Any]], groups: list[dict[str, Any]]) -> None:
    specs: dict[int, dict[str, Any]] = {
        ...
        7: {
            ...
            "points": [
                {"title": "痛苦斗兽场·伊戈达斯 / 猛犸人", "action": "古尔戈索克 → 交《勇士的召唤！》 → 接《痛苦斗兽场：伊戈达斯！》\n↳ 做《痛苦斗兽场：伊戈达斯！》\n巨魔仆从伍迪 → 交《痛苦斗兽场：伊戈达斯！》\n古尔戈索克 → 接《痛苦斗兽场：猛犸人！》\n↳ 做《痛苦斗兽场：猛犸人！》\n巨魔仆从伍迪 → 交《痛苦斗兽场：猛犸人！》", "note": "《痛苦斗兽场：伊戈达斯！》：第一场同时作为战斗压力门槛；若主控明显打不过或失败重跑成本高，就停止后五场，整条以后补。", "fivebox": "先确认伊戈达斯是否五号同步完成；后续各场继续观察。"},
