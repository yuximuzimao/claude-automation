...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Zangarmarsh task-profile special-mechanism review queue."
    )
    ...
    payload = {
        "meta": {
            "scope": "zangarmarsh_task_profile_pipeline",
            "purpose": "Find Zangarmarsh quests whose Questie objective markers may not represent the real execution entry or mechanic.",
