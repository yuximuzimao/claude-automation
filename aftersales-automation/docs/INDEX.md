...
**商责售后原因**：`MERCHANT_FAULT_REASONS` 在 `lib/constants.js` 中维护。2026-05-21 新增 `'质量问题'`——此前因漏加导致商责工单穿透到非商责流程（fb-1778868858729 / fb-1779092166923）。2026-06-11 新增 `'卖家发错货'`，覆盖鲸灵原因文案。如需追加商责关键词，在该数组中新增。
