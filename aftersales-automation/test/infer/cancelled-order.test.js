...
describe('P0-4: 已取消工单 escalate 转人工', () => {
  it('workOrderStatus="已取消" → action=escalate', () => {
  ...
  it('workOrderStatus="取消中" → action=escalate（不入终态）', () => {
    const fixture = loadFixture('fb-1779121317343.json');
  ...
  it('workOrderStatus="用户已取消" → action=escalate', () => {
    const fixture = loadFixture('fb-1779121317343.json');
