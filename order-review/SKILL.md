---
name: order-review
description: 审单项目导航：原订单读取、本地包裹方案、受控ERP执行和独立装箱实验/1～N箱算法。
---
...
| 任务 | 入口 |
|---|---|
| 接手装箱实验/算法 | `tasks/todo.md` → `docs/CURRENT.md` → `docs/2026-09-12-packing-algorithm-research.md` → `docs/2026-09-08-packing-simulator-plan.md` |
