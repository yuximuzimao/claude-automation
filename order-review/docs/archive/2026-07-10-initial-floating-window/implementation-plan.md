...
> Archived on 2026-07-10. This plan has been completed and is kept only as implementation history. The former recommendation direction is archived at `../2026-08-14-carton-packing-foundation/approximate-recommendation-direction.md`; current direction and operating notes live in `../../../README.md` and `../../../AGENTS.md`; the completed package-plan requirements are archived at `../2026-07-22-package-plan/requirements.md`.
