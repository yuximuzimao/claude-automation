...
- hee 尚未训练；已知待图新品以 `../product-mapping/tasks/todo.md` 的 HEE 新品视觉待办为准，不能当作未知类别或借旧图建类
...
| HEE 已知待图新品 | `../product-mapping/tasks/todo.md`（HEE 新品视觉待办） |
...
../product-mapping/tasks/todo.md ← HEE 尚未完成视觉建档新品的当前待办
tests/
...
6. 若任务涉及 HEE/悦希，先读 `../product-mapping/tasks/todo.md` 的 HEE 新品视觉待办；尚未补齐实际商品图的新品只能标记为已知待补，不能生成训练类别
