...
| 状态 | 标签 / 数据 | 说明 |
|------|-------------|------|
| 已整理可用 | 精灵、课题、进化链、异色炫彩、多形态、精灵果实、家具、遗迹 | 最新 Excel 的 N.001–N.439 已同步：439 只精灵、2192 条课题、191 条进化链、170 条果实记录和 144 个多形态项；已有任务进度已按新索引迁移 |
| 已审计、少量来源冲突待确认 | 最新 Excel / 官方图片 | 全量差异报告见 `tasks/latest-excel-audit.md`。当前仅保留名称“幽灵眼/幽冥眼”、蹦蹦种子家族“象牙花/象牙球”、十字蝌蚪家族第二系别，以及 Excel 内部格式/占位问题等待人工确认 |
