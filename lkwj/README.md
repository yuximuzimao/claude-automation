...
| 基础资料已入库、任务待补 | S3 图片资料 | 奇遇 No.422–439 已录入 18 只；第二批另录入 16 只、7 个家族，其中加灵家族为分支进化，足尖元件与咬咬小子家族带 S3 通行证异色。第二批编号暂按 `pet_440–455` 连续占位，等待官方编号资料统一核对；课题、精确进化条件、果实和个人进度待补 |
