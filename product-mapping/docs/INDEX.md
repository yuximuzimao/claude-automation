...
- `[1/2026-09-16]` **换绑成功后可能残留空的“换对应商品”弹窗**：候选表已清空、ERP 绑定已成功，但旧 wrapper 仍可见，会遮在下一条新打开的“选择商品”上方。每个 SKU 开始前按标题依次关闭残留“换对应商品”和“选择商品”，确认两层均隐藏后再继续；禁止取第一个可见 dialog 猜当前步骤。
