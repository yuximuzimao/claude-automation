# 历史 lessons 快照（整理于 2026-07-25）

> 本文件保存整理前的原始经验，包含已过期或互相冲突的结论，仅供追溯。
> 当前规则以 `../../matching-stability.md`、`../../INDEX.md` 和代码为准。
> 特别注意：本文件关于对应表搜索框填 platformCode 的旧结论已被 2026-07-24
> 澜泽实测推翻；当前实现按 productCode（货号）搜索。
